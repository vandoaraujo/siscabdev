...
public class TipoServicoDao {
	...
	TipoServico tipoS = (TipoServico) session
		.createQuery(
			"from modelo.TipoServico o where o.tiposervico_descricao=:nome")
	...
	List<TipoServico> l = session.createQuery("from modelo.TipoServico")
		.list();
	return l;
