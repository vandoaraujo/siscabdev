...
public class VitimaAtendidaDao {
	...
	VitimaAtendida vitima = (VitimaAtendida) session
		.createQuery(
			"atend from modelo.Vitima v, modelo.Atendimentos atend where atend.id = v.atendimento")
		.uniqueResult();
	return vitima;
    }
	...
	VitimaAtendida vitima = (VitimaAtendida) session.load(
		VitimaAtendida.class, id);
	return vitima;
    }
	...
	List<VitimaAtendida> l = session.createQuery(
		"from modelo.VitimaAtendida").list();
	return l;
    ...
    public List<VitimaAtendida> listaVitimasReferenteUmAtendimento(
	    int atendimentoId) {

	List<VitimaAtendida> vitimas = session
		.createQuery(
			"from modelo.VitimaAtendida v where v.atendimento_id=:atendimentoVitimas")
		.setInteger("atendimentoVitimas", atendimentoId).list();
	return vitimas;
    }
