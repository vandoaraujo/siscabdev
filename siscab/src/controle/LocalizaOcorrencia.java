...
public class LocalizaOcorrencia extends HttpServlet {
	...
	int numeroGeradoChamado = Integer.parseInt(request
		.getParameter("idChamado")); // cast

	// Este parametro não é usado para este caso de Uso...Seria apenas para
	// log.
	String nomeUsuario = request.getParameter("usuario");

	// Esta Obm do objeto chamado irá entrar no Caso de Uso transferir
	// Atendimento como OBM default...
