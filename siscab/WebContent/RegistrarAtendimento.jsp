...
<%@ page
	import="java.util.*,modelo.TipoOcorrencia,dao.TipoOcorrenciaDao,modelo.OBM,modelo.Usuario,modelo.NaturezaChamado,modelo.Municipio,dao.OBMDao,modelo.StatusAtendimento,modelo.TipoOcorrencia"%>
	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Registrar
				Atendimento&nbsp;</legend> Obs: O presente Chamado possui uma Natureza de
				Solicitação de Socorro.<br>
				...
				<table>
					<tr>
						<td>Numero gerado:</td>
						<td><input name="idAtendimento" type="text"
							readonly="readonly" value="${idNumeroAtendimento}"></td>
					</tr>
					<tr>
						<td>OBM a Prestar Atendimento:</td>
						<td><input name="obmAtendimento" type="text"
							readonly="readonly" value="${obmAtendimento}"></td>
					</tr>
					<tr>
						<td>Bairro:</td>
						<td><input name="bairro" type="text" readonly="readonly"
							value="<%=request.getAttribute("bairro")%>"></td>
					</tr>
					<tr>
						<td>Municipio:</td>
					...
					<tr>
						<td colspan="2"><font color="blue">Você deseja
						repassar o atendimento para o COCB? </font> Sim: <input
							name="radiobutton" type="radio" value="sim"
							onClick="habilitaCombo('seleciona','s');"> Não: <input
							name="radiobutton" type="radio" value="nao" checked
							onClick="habilitaCombo('seleciona','n');"></td>
					<tr>
						<td>
						...
						<td><select name="obmRepassaAtendimento" id="seleciona"
							disabled="disabled">
					...
					<tr>
						<td>Coord X:</td>
						<td><input name="coordX" type="text" readonly="readonly"
							value="<%=request.getParameter("hiddenCoordX")%>"></td>
					</tr>
					<tr>
						<td>Coord Y:</td>
						<td><input name="coordY" type="text" readonly="readonly"
							value="<%=request.getParameter("hiddenCoordY")%>"></td>
					</tr>
					<tr>
						<td>Logradouro:</td>
						<td><input name="logradouro" type="text" size=30
							value="${endereco}"></td>
					<tr>
					...
					<tr>
						<td colspan="2"><input type="submit"
							value="Registrar Atendimento"></td>
					</tr>
				</table>
				</form>
				</fieldset>
