function mmLoadMenus() {
  ...
  mm_menu_0217221104_0.addMenuItem("Acompanhar&nbsp;Viatura");
  mm_menu_0217221104_0.addMenuItem("Registrar&nbsp;Vítimas");
  mm_menu_0217221104_0.addMenuItem("Registrar&nbsp;Serviços");
  ...
  window.mm_menu_0217221434_0 = new Menu("root",79,23,"Trebuchet MS",13,"#FFFFFF","#000000","#5557A7","#BABBDC","left","middle",5,1,1000,-5,7,true,false,true,0,true,true);
  mm_menu_0217221434_0.addMenuItem("Usuários","location='administracao_usuario.jsp'");
  mm_menu_0217221434_0.addMenuItem("OBMs","location='ObmControle'");
