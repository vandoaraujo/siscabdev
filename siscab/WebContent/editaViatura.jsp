...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Viatura,modelo.TipoViatura,dao.OBMDao,dao.TipoViaturaDao"%>
	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Editar
				Viatura&nbsp;</legend>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					...
					<tr>
						<td colspan="2"><input type="submit" value="Alterar"
							...
							type="hidden" name="registroViatura" value="${viaturaAtual.id}">
						</form>
