	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 780px"><legend>&nbsp;Lista
				de Atendimentos Nao Finalizados&nbsp;</legend>
				<div style="color: red">Clique em um Atendimento para
				alteraçöes</div>
				...
				<h2>Nenhum Atendimento com Status = "Pendente" cadastrado
				<p>Retorne ao menu:
				<h4><a href="paginaPrincipal.jsp" title="Menu">Menu</a></h4>
				</h2>
				...
				<table cellspacing="4" cellpadding="4">
					...
					<tr>
						<td><%= i+1 %> :: NúmeroAtendimento: <%=atendimentos.getAtendimento_numero()%>
						<a
							href="EditaAtendimento?registro=<%=atendimentos.getAtendimento_numero()%>">
						Municipio:<%= atendimentos.getMunicipio_id().getMunicipio_nome()%>,
						Bairro: <%=atendimentos.getBairro()%>, Logradouro: <%=atendimentos.getLogradouro()%>,
						TipoOcorrencia: <%=atendimentos.getTipoocorrencia().getTipoocorrencia_descricao() %>,
						QtdVitimas: <%=atendimentos.getChamado_id().getNumaproxvitimas()%>,
						OBMAtendimento: <%=atendimentos.getObm_id().getNome()%></a></td>
					</tr>
					<tr>
						<td>
						<hr>
