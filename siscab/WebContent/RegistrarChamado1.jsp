...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,modelo.NaturezaChamado,modelo.Municipio"%>
	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Cadastro
				de Chamados&nbsp;</legend>
				...
				<table>
					<tr>
						<td valign="top">
						<fieldset style="width: 450px"><legend>&nbsp;Parte
						1&nbsp;</legend>
						<table>
							<%! String grava = null;%>
							...
							<tr>
								<td>Numero gerado:</td>
								<td><input name="idChamado" type="text" readonly="readonly"
									value="${idChamado}"></td>
							</tr>
							<tr>
								<td>Usuário:</td>
								<td><input name="usuario" type="text" readonly="readonly"
									value="${usuario.nomeGuerra}"></td>
							</tr>
							<tr>
								<td>Obm do Usuário:</td>
								<td><input name="obmUsuario" type="text"
									readonly="readonly" value="${usuario.obm.nome}"></td>
							</tr>
							<tr>
								<td>Município:</td>
							...
							<tr>
								...
								<td><input type="submit"
									value="Procurar Ocorrencias Proximas"
									onclick="this.form.operacaoARealizar.value=2"></td>
							</tr>
						</table>
						</fieldset>
						</td>
						...
						<table>
							...
							<tr>
								...
								<td><input name="endereco" type="text" size=30><input
									name="numero" type="text" size=6></td>
							</tr>
							<tr>
							...
							<tr>
								<td></td>
								<td><input type="submit" value="Localizar no Mapa"
									onclick="this.form.operacaoARealizar.value=1"></td>
