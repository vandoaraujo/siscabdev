...
<title>SISCAB - Relatório de Total de Atendimentos por Modo de
Fechamento</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<fieldset style="width: 900px"><legend>&nbsp;
			RELATÓRIO DE ATENDIMENTOS POR MODO DE FECHAMENTO&nbsp;</legend></fieldset>
						...
						<table border=1 cellspacing=0 cellpadding=0>
							<tr>
								...
								<p class=MsoNormal
									...
									style='mso-bidi-font-weight: normal'><span lang=PT-BR>Modo
								de Fechamento do Atendimento</span></b></p>
								</td>
