...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,dao.TipoServicoDao,dao.VitimaAtendidaDao,modelo.ServicoRealizado,modelo.TipoServico"%>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					...
					<tr>
						<td colspan="2"><input type="submit" value="Incluir"
							...
							type="hidden" name="registroServico" value="1"></td>
					</tr>
				</table>
				</form>
				</fieldset>
