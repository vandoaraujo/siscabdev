	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 520px"><legend>&nbsp;Sugestão
				de Rota&nbsp;</legend>
				<form><input type="hidden" name="CoordX_Operador"
					id="CoordX_Operador"
					value="<%=request.getAttribute("CoordX_Operador") %>"> <input
					type="hidden" name="CoordY_Operador" id="CoordY_Operador"
					value="<%=request.getAttribute("CoordY_Operador") %>"> <input
					type="hidden" name="CoordX_Acidente" id="CoordX_Acidente"
					value="<%=request.getAttribute("CoordX_Acidente") %>"> <input
					type="hidden" name="CoordY_Acidente" id="CoordY_Acidente"
					value="<%=request.getAttribute("CoordY_Acidente") %>"></form>
				<%! Usuario usuario; %> <% usuario = (Usuario)request.getAttribute("usuario");%>
				...
				<table>
					<tr>
						...
						<table>
							<tr>
								<td>
								<fieldset style="width: 220px"><legend>&nbsp;Ponto
								de Origem&nbsp;</legend>
								<table width="100%">
									<tr>
										<td width="80%">
										<div id="NomeOrigem">Nome: <%=request.getAttribute("NomeOrigem").toString()%>
										</div>
										<div id="EnderecoOrigem">Endereço: <%=request.getAttribute("EnderecoOrigem").toString()%>,
										<%=request.getAttribute("NumeroOrigem").toString()%></div>
										<div id="BairroOrigem">Bairro: <%=request.getAttribute("BairroOrigem").toString()%>
										</div>
										<div id="MunicipioOrigem">Município: <%=request.getAttribute("MunicipioOrigem").toString()%>
										</div>

										</td>
										<td align="center" valign="top"><img
											src="img/pontoOrigem.gif" /></td>
									</tr>
								</table>
								</fieldset>
								</td>
								...
								<table width="100%">
									<tr>
										<td width="80%">
										<div id="NumeroAtendimento">Atendimento: Nº <%=request.getAttribute("NumeroAtendimento").toString()%>
										</div>
										<div id="EnderecoDestino">Endereço: <%=request.getAttribute("EnderecoDestino").toString()%>,
										<%=request.getAttribute("NumeroDestino").toString()%></div>
										<div id="BairroDestino">Bairro: <%=request.getAttribute("BairroDestino").toString()%>
										</div>
										<div id="MunicipioDestino">Município: <%=request.getAttribute("MunicipioDestino").toString()%>
										</div>
										</td>
										<td align="center" valign="top"><img
											src="img/pontoDestino.gif" /></td>
									</tr>
								</table>
								</fieldset>
								</td>
