...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,modelo.Atendimento,modelo.ModoFechamento,dao.TipoServicoDao,dao.VitimaAtendidaDao,modelo.ServicoRealizado"%>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					...
					<tr>
						...
						<td><input name="idAtendimento" type="text" size=5
							readonly="readonly" value="${registroAtendimento}" /></td>
					</tr>
					<tr>
						<td><label>Numero Atendimento:</label></td>
						<td><input name="numeroAtendimento" type="text" size=5
							readonly="readonly" value="${numeroAtendimento}" /></td>
					</tr>

					<tr>
						<td colspan="2"><input type="submit"
							value="Finalizar Chamado" /></td>
					</tr>
				</table>
				</form>
				</fieldset>
