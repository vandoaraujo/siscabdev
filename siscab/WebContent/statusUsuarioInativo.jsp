	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Acesso
				negado&nbsp;</legend> <br>
				<div style="color: red; display: inline">Prezado(a) <%=usu.getNomeGuerra() %>,
				seu status atual é: <%= usu.getStatus() %>! Contate o administrador
				para trocar seu status para ativo.</div>
