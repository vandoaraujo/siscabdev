	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 750px"><legend>&nbsp;Finalizar
				Atendimento&nbsp;</legend>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					<tr>
						<td><label>Este Atendimento possui as seguintes
						viaturas abaixo alocadas e serão liberadas após o fechamento deste
					...
					<tr>
						...
						<% 
											...
											for(int i=0;i<viatura.size();i++){
												%><font color="green"> <%out.print("* Número da Viatura: " + viatura.get(i).getNumero());
												%> - </font><font color="red"> <%
					...
					<tr>
						...
						<td><input name="modoFechamento" type="text" size=5
							readonly="readonly" value="${modoFechamento}"
							style="width: 138px;" /></td>
					</tr>
					<tr>
						<td><label style="COLOR: #0000a0;">Numero
						Atendimento:</label></td>
						<td><input name="numeroAtendimento" type="text" size=5
							readonly="readonly" value="${numeroAtendimento}"
							style="width: 138px;" /></td>
					</tr>
					<tr>

						<td><label style="COLOR: #0000a0;">Id Atendimento:</label></td>
						<td><input name="idAtendimento" type="text" size=5
							readonly="readonly" value="${idAtendimento}"
							style="width: 138px;" /></td>
					</tr>
