	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<a href="novaVitima.jsp">Adicionar Vítima</a></fieldset>
				</td>
			</tr>
			<tr>
				<td style="padding-left: 20px; padding-top: 20px;">
				<fieldset style="width: 450px"><legend>&nbsp;Lista
				de Vitimas Cadastrados&nbsp;</legend>
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					...
					<tr>
						<td><%= i+1 %> :: <a
							href="EditaVitima?registro=<%=vitima.getId()%>&atendimentoAtual=<%=vitima.getAtendimento().getId()%>">Nome:
						<%= vitima.getNome()%> SituacaoVitima: <%= vitima.getVitima_situacao()%></a><br>
						</td>
					</tr>
					<%} 	
										}%>
