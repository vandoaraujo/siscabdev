	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 700px"><legend>&nbsp;Lista
				de Atendimentos Vinculadas a ${obm}&nbsp;</legend>
				...
				<h2>Nenhum Atendimento não finalizado no momento vinculado a
				sua ${obm}
				<p>Retorne ao menu:
				...
				<table cellspacing="4" cellpadding="4">
					...
					<tr>
						...
						<a
							href="RepasseAtendimento?registro=<%=atendimentos.getId()%>&perfilUsuario=<%=usuario.getPerfil().getId()%>">
