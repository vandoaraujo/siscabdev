...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,modelo.Atendimento"%>
	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Procurar
				Ocorr&ecirc;ncias Pr&oacute;ximas&nbsp;</legend> <% ArrayList atendimento=(ArrayList<Atendimento>) request.getAttribute("listaAtendimentosProximos");
				...
				<fieldset><font color="darkgreen"> <strong>Número
				do Atendimento:</strong> <%= atend.getAtendimento_numero()%> <br>
				...
				<form action="RegistrarChamado" method="post"
