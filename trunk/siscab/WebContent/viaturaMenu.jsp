	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 150px"><legend>&nbsp;Incluir
				Viatura&nbsp;</legend> <a href="novaViatura.jsp">Incluir</a></fieldset>

				<fieldset style="width: 160px"><legend>&nbsp;Buscar
				Viatura&nbsp;</legend> <a href=ConsultaViaturas>Procurar Viatura</a></fieldset>
				</td>
			</tr>
			<tr>
				<td>
