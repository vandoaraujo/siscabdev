	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 200px"><legend>&nbsp;Incluir
				OBM&nbsp;</legend> <a href="novaObm.jsp">Incluir</a></fieldset>
				</td>
			</tr>
			<tr>
				<td style="padding-left: 20px; padding-top: 20px;">
				<fieldset style="width: 600px"><legend>&nbsp;Lista
				de OBMs cadastradas&nbsp;</legend>
...
%>
					...
					<tr>
						<td>
						<div><%= i+1 %> :: <a
							href="EditaOBM?registro=<%=obm.getId()%>"> Nome:<%= obm.getNome()%>,
						Cidade: <%=obm.getMunicipio().getMunicipio_nome()%> ,<%= obm.getBairro()%>,Status:
