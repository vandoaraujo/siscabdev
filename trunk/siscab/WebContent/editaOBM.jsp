	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 350px"><legend>&nbsp;Editar
				de OBM&nbsp;</legend>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					...
					<tr>
						...
						<td><select name="municipio">
							<option selected>${obmAtual.municipio.municipio_nome} <!-- Popula a combo que aparecerá na tela -->
							<%
					...
					<tr>
						...
						<td><input name="bairro" type="text"
							value="${obmAtual.bairro}" /></td>
					</tr>
					<tr>
						<td><label>Logradouro:</label></td>
						<td><input name="logradouro" type="text"
							value="${obmAtual.logradouro}" /></td>
					</tr>
					<tr>
						<td><label>Num. Complemento:</label></td>
						<td><input name="numComplemento" type="text"
							value="${obmAtual.numCompl}" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<%  
									    ...
									    %> O perfil atual desta OBM é Ativa. No momento seu Status
						está sendo trocada para Inativa Ativa <input name="statusObm"
							type="radio" value="ativa" /> Inativa <input name="statusObm"
							type="radio" value="inativa" checked /> <%} else if (obmVO.getStatus() == 0){
									    	 %> O perfil atual deste OBM é Inativa. No momento seu
						status será trocada para Ativa Ativo <input name="statusObm"
							type="radio" value="ativa" checked /> Inativo <input
							name="statusObm" type="radio" value="inativa" /> <% }%>
						</td>
					</tr>
					<tr>
						<td colspan="2"><input type="submit" value="Alterar"
							...
							type="hidden" name="registroOBM" value=${obmAtual.id}>
						</form>
