...
<%@ page
	import="org.apache.log4j.BasicConfigurator,org.apache.log4j.Level,org.apache.log4j.Logger"%>
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr style="height: 110px" valign="top">
						...
						<center>
						<h3>Seja bem-vindo. Para acessar o sistema, entre com o
						número de registro e senha.</h3>
						</center>
						</td>
					</tr>
					<tr>
						...
						<table width="210" border="0" cellpadding="5" cellspacing="0">
							<tr>
								...
								<td class="campo" width="130"><input name="numRegistro"
									type="text" size="15"></td>
							</tr>
							<tr>
								<td class="texto" width="80">Senha:</td>
								<td class="campo" width="130"><input name="senha"
									type="password" size="15"></td>
							</tr>
							<tr>
								<td colspan="2" class="campo_centralizado"><input
									type="submit" name="evento" value="Login"></td>
							</tr>
							<tr>
								<td colspan="2" class="campo_centralizado"><font color=red>
								${mensagem}</font></td>
							</tr>
						</table>
						</td>
