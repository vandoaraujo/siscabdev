	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				de Viaturas Em prontidão&nbsp;</legend>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					<tr>
						...
						<% ArrayList viatura=(ArrayList<Viatura>) request.getSession().getAttribute("viaturasEmProntidao");
										%> <% if(viatura.size()== 0){ %>
						<div style="color: red">Nenhuma Viatura em prontidão neste
						momento para a ${obm}</div>
					...
					<% idViatura = via.getId(); %>
					<tr>
						<td><input type="radio" name="viatura"
							value="<%= idViatura %>" /> Descrição <%=via.getTipo_viatura().getTipoviatura_descricao() %>
						Número Viatura: <%= via.getNumero() %></td>
					</tr>
					<tr>
						<%} 
