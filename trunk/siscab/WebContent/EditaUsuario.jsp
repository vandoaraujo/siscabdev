	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Alterar
				Usuário&nbsp;</legend>
				<form action="NovoUsuarioServlet" method="get">
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					<tr>
						<td><label>Nº de Registro:</label></td>
						<td><input name="registro" type="text"
							value=${usuario.numRegistro } readonly="readonly" /></td>
					</tr>
					<tr>
						<td><label>Nome de Guerra:</label></td>
						<td><input name="nomeGuerra" type="text"
							value=${usuario.nomeGuerra } /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<%  
									    ...
									    %> O perfil atual deste Usuário é Ativo. No momento seu
						status será trocado para Inativo Ativo <input name="status"
							type="radio" value="ATIVO" /> Inativo <input name="status"
							type="radio" value="INATIVO" checked /> <%} else if (usuario.getStatus().equals("INATIVO")){
									    	 %> O perfil atual deste Usuário é Inativo. No momento seu
						status será trocado para Ativo Ativo <input name="status"
							type="radio" value="ATIVO" checked /> Inativo <input
							name="status" type="radio" value="INATIVO" /> <% }%>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="senha" type="text" size="30"
					...
					<tr>
						<td colspan="2"><input type="submit" value="Alterar"
							...
							type="hidden" name="registroUsuario" value=${usuario.id} >
						</form>

						<form action="BuscarUsuario" method="post"
							style="display: inline;"><input type="hidden"
							name="registro" value=${usuario.numRegistro} > <input
							type="hidden" name="nomeGuerra" value=${usuario.nomeGuerra} >
						<input type="submit" name="evento" value="Voltar" /></form>
						</td>
					</tr>
					</fieldset>
					</td>
