									    ...
									    %> 									    									  									    
									     ...
									     <%} %>
									    	...
									    	<td>
									    		...
									    		<a href="CrudVitima?operacaoARealizar=3&registroVitima=<%=vitima.getId()%>&atendimentoAtual=0" onclick="if (!confirm('Confirma a exclusão?')) return false"><img src="img/btnExcluir.gif" border="0"></a>									    		
									       	</td>									       	
									    </tr>								    										
									   <%} 
									}%>
