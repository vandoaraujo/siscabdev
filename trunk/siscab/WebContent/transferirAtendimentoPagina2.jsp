	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 450px"><legend>&nbsp;Repassar
				Atendimento&nbsp;</legend> <% Usuario usuario = (Usuario) getServletContext().getAttribute("usuarioCorrente");
				...
				<table>
					...
					<tr>
						...
						<td><input name="numeroAtendimento" type="text" size=20
							value="<%= at.getAtendimento_numero() %>"></td>
					</tr>
					<tr>
