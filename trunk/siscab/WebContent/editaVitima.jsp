...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,modelo.VitimaAtendida,dao.VitimaAtendidaDao"%>
	...
	<tr
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<fieldset style="width: 520px"><legend>&nbsp;Editar
				Vitima&nbsp;</legend>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					<tr>
						...
						<td colspan="8"><input name="nome" type="text" size=40
							value="${vitima.nome}" /></td>
					</tr>
					<tr>
						<td><label>Idade:</label></td>
						<td colspan="8"><input name="idade" type="text" size=3
							maxlength="3" value="${vitima.idade}" /></td>
					</tr>
					<tr>
						...
						<%  vitima = (VitimaAtendida) request.getAttribute ("vitima"); 
											if(vitima.getCor() == 1){
									    	 %>
						<td width="10px"><input name="cor" type="radio"
							value="branca" checked /></td>
						<td>Branca</td>
						...
						<td width="10px"><input name="cor" type="radio"
							value="branca" /></td>
						<td>Branca</td>
						<td width="10px"><input name="cor" type="radio" value="parda"
							checked /></td>
						<td>Parda</td>
						<td width="10px"><input name="cor" type="radio"
							value="amarela" /></td>
						...
						<td width="10px"><input name="cor" type="radio"
							value="amarela" /></td>
						<td>Amarela</td>
						<td width="10px"><input name="cor" type="radio" value="negra"
							checked /></td>
						<td>Negra</td>
					...
					<tr>
						...
						<% vitima = (VitimaAtendida) request.getAttribute ("vitima"); 
									     if(vitima.getSexo() == 'M'){
									    	 %>
						<td width="10px"><input name="sexo" type="radio" value="M"
							checked /></td>
						<td>M</td>
						<td width="10px"><input name="sexo" type="radio" value="F" /></td>
						<td colspan="5">F</td>
						<%} else{
									    	 %>
						<td width="10px"><input name="sexo" type="radio" value="F"
							checked /></td>
						<td>F</td>
					...
					<tr>
						...
						</select> <% } else if (vitima.getVitima_situacao() == 2){
										  %>
						...
						<option>4 - Encaminhada ao suporte aeromédico</option>
						<option>5 - Óbito no local</option>
						</select> <% } else if (vitima.getVitima_situacao() == 3){
										  %>
						<option>1 - Recusou Atendimento</option>
						<option>2 - Entregue ao hospital</option>
						<option selected>3 - Permaneceu no local após ser
						atendida</option>
						<option>4 - Encaminhada ao suporte aeromédico</option>
						<option>5 - Óbito no local</option>
						</select> <% } else if (vitima.getVitima_situacao() == 4){
											 %>
						<option>1 - Recusou Atendimento</option>
						<option>2 - Entregue ao hospital</option>
						<option>3 - Permaneceu no local após ser atendida</option>
						...
						<option>5 - Óbito no local</option>
						</select> <% } else if (vitima.getVitima_situacao() == 5){
											%>
						<option>1 - Recusou Atendimento</option>
						<option>2 - Entregue ao hospital</option>
						<option>3 - Permaneceu no local após ser atendida</option>
					...
					<tr>
						...
						<td colspan="8"><input name="hospital" type="text" size=40
							value="${vitima.hospitaldestino}" /></td>
					</tr>
					<tr>
						<td colspan="9"><input type="submit" value="Alterar"
							...
							type="hidden" name="registroVitima" value="${vitima.id}" /> <input
							type="hidden" name="atendimentoAtual" value="${atendimentoAtual}" />
						</td>
					</tr>
				</table>
				</form>
