...
<%@ page
	import="java.util.*,modelo.OBM,modelo.Usuario,modelo.Municipio,dao.MunicipioDao,modelo.TipoEventoViatura"%>
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="3" width="100%">
					<tr>
						...
						<td><input name="registroEventoViatura" type="text" size=10
							readonly="readonly" value="${viaturaAtual}" /></td>
					</tr>
					<% String numero = (String) request.getAttribute("numeroViatura");%>
					<tr>
						<td><label>NumeroViatura:</label></td>
						<td><input name="numeroViatura" type="text" size=10
							readonly="readonly" value="<%= numero %>" /></td>
					</tr>
					<tr>
						<td><label>IdAtendimento:</label></td>
						<td><input name="registroEventoAtendimento" type="text"
							size=10 readonly="readonly" value="${atendimentoAtual}" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><input type="submit" value="Incluir"
							...
							type="hidden" name="operacaoARealizar" value="">
						</form>
						</td>
					</tr>
					<tr>
