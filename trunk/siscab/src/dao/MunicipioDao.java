...
public class MunicipioDao {
	...
	Municipio municipio = (Municipio) session.createQuery(
		"from modelo.Municipio m where m.municipio_nome=:municipio")
		.setString("municipio", nome).uniqueResult();
	tx.commit();
	return municipio;
	...
	List<Municipio> l = session.createQuery(
		"from modelo.Municipio order by municipio_nome").list();
	return l;
