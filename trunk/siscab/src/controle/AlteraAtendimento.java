...
public class AlteraAtendimento extends HttpServlet {
	...
	TipoOcorrencia tipoO = TipoOcorrenciaDao.getInstance()
		.listarTiposOcorrenciaNome(tipoOcorrencia);
	...
	despacha(request, response, "alterar", atendimento
	...
	registroId = Integer.parseInt(request
	...
	atendimento = AtendimentoDao.getInstance().BuscaAtendimentoId(
		registroId);
